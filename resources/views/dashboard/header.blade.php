<div class="row border-bottom white-bg dashboard-header">
    <div class="col-sm-10">
        <h2>Welkom op het Extranet ordertracking systeem van Matas Electronics B.V.</h2>
        <p>Hier vindt u alle informatie met betrekking tot uw orders, reparaties, voorraad, offertes en facturen.</p>
